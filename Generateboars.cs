...
public class Generateboars : MonoBehaviour

{
    ...
    IEnumerator EnemyDrop()
    {
        ...
        while (enemyCount < 5)// 125, 250 default how many enemies you need 300 is really enough or too much after that you cant move
        {
