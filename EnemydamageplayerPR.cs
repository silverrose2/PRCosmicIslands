...
public class EnemydamageplayerPR : MonoBehaviour// This scrip attaches to a bullet. ref what bullet is hitting for damage
{// Dont forget tag Enemy in Unity as Enemy *****************************
    ...
    // can use OnCollisionEnter too 
    {
        ...
        if (other.tag == "Player"|| other.tag == "Playerdetector2") // more target
