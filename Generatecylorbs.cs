...
public class Generatecylorbs: MonoBehaviour

{
    ...
    IEnumerator EnemyDrop()
    {
        ...
        while (enemyCount < 11)//x3 spawns// 125, 250 default how many enemies you need 300 is really enough or too much after that you cant move
        {
            ...
            zPos = Random.Range(-800, 200);// -35,40""// default was -50,30 t
