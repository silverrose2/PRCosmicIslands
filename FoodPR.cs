...
public class FoodPR: MonoBehaviour// This scrip attaches to a bullet. ref what bullet is hitting for damage
{// Dont forget tag Enemy in Unity as Enemy *****************************
    public int damageToGive;// access to enemy health now o player ignore set 0 pay attention to the upper and lower case formats
