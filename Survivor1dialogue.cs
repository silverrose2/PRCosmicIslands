...
public class Survivor1dialogue : MonoBehaviour
{

    public TextMeshProUGUI Text1;
    public TextMeshProUGUI Text2;
    public TextMeshProUGUI takecover;
    public GameObject Survivor1Camera;
    public GameObject Maincamera;
    public GameObject Helirescue;
    ...
    void Start()
    {
        ...
        Survivor1Camera.SetActive(false);
        Helirescue.SetActive(false);
        Text1.enabled = false;
        Text2.enabled = false;
        takecover.enabled = false;
    ...
    public void OnTriggerEnter(Collider other)// New to stop NPC on contact with player to avoid push/ tree
    {
        if (other.tag == "Player")// on trigger these activate
        {
            ...
            Survivor1Camera.SetActive(true);
        ...
        IEnumerator delay(int v) // need to switch off respawn
        {
            ...
            Text1.enabled = false;
            Text2.enabled = true;
            Helirescue.SetActive(true);
            yield return new WaitForSeconds(6.0f);

            Survivor1Camera.SetActive(false);// resumes
            ...
            yield return new WaitForSeconds(9.0f);//9
            Survivor1.SetActive(false);
