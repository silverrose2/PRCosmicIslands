...
public class GeneratespidersPR : MonoBehaviour

{
    ...
    IEnumerator EnemyDrop()
    {
        ...
        //**********************************************************update
        yield return new WaitForSeconds(5);//new delay for spawn pr// note 35 is last default cout changed to 15 7.4.23
        //55 last default count
        while (enemyCount < 30)//7 Last/x3 spawns// 125, 250 default how many enemies you need 300 is really enough or too much after that you cant move
        {
            ...
            zPos = Random.Range(-1000, -200);// -35,40""// default was -50,30 t//     zPos = Random.Range(-160, -600);
