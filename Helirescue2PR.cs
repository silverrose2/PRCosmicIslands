...
public class Helirescue2PR : MonoBehaviour// cereated for snow level (2) as conflict with share helirescue
{
    public float speed;
    ...
    void Update()
    {
...

        {
            ...
            tele1.SetActive(true);// tele porter and level select
            tele2.SetActive(true);
            tele3.SetActive(true);
            tele4.SetActive(true);

            takecovertext.SetActive(true);// note using obj here to control destroy after time make way to teleporter
            Destroy(takecovertext, 8);
